...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText DniForm;
    private EditText CantidadForm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NameForm = findViewById(R.id.Nombre);
        NameForm.setVisibility(View.GONE);

        LastNameForm = findViewById(R.id.Apellido);
        LastNameForm.setVisibility(View.GONE);

        PhoneForm = findViewById(R.id.Telefono);
        PhoneForm.setVisibility(View.GONE);

        EmailForm = findViewById(R.id.EMail);
        EmailForm.setVisibility(View.GONE);

        DniForm = findViewById(R.id.DNI);
        DniForm.setVisibility(View.GONE);

        CantidadForm = findViewById(R.id.Cantidad);
        CantidadForm.setVisibility(View.GONE);
    ...
    private void startPayment(){
        ...
        //mostrar el form nuevo
        NameForm.setVisibility(View.VISIBLE);
        LastNameForm.setVisibility(View.VISIBLE);
        PhoneForm.setVisibility(View.VISIBLE);
        EmailForm.setVisibility(View.VISIBLE);
        DniForm.setVisibility(View.VISIBLE);
        CantidadForm.setVisibility(View.VISIBLE);
    ...
    private SynapTransaction buildTransaction(){
        ...
        //address.getLevels().add(departamento); // Código de Área (Ubigeo - Departamento)
        //address.getLevels().add(provincia); // Código de Área (Ubigeo - Provincia)
        //address.getLevels().add(distrito); // Código de Área (Ubigeo - Distrito)
        //address.setLine1(direccion); // Dirección
        ...
        cardStorage.setUserIdentifier(mail); // Puede ser cualquier identificador definido por el comercio
